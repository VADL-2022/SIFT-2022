...
bool startDelayedSIFT() {
  ...
  std::string s = "./sift_exe_release_commandLine --main-mission --sift-params -C_edge 2 --sleep-before-running " + std::string(timeFromTakeoffToMainDeploymentAndStabilization);
