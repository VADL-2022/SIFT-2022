...
extern thread_local char* mallocWithFreeAll_origPtr;
extern thread_local char* mallocWithFreeAll_current;
extern thread_local char* mallocWithFreeAll_max;
extern thread_local enum MallocImpl currentMallocImpl;
