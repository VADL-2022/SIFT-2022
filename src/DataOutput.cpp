...
void PreviewWindowDataOutput::run(FolderDataSource& src, SIFTState& s, SIFTParams& p, cv::Mat& backtorgb, struct sift_keypoints* keypoints, bool retryNeeded, size_t& index, int n // Number of keypoints
) {
...
//template<>
//void runDataSource(FileDataOutput& o, ARGS) {
//    //o.run(src, s, p, backtorgb, keypoints, retryNeeded, index, n);
//}
#undef ARGS
