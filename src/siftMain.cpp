...
//        OPTICK_THREAD("Worker");
        ...
        t.reset();
        bool enoughDescriptors = sift.findHomography(img1, img2 // Writes to img2.transformation
#ifdef USE_COMMAND_LINE_ARGS
                            , g_src, cfg
#endif
                            );
        if (!enoughDescriptors) {
            ...
            bool enoughDescriptors2 = sift.findHomography(img1, img3 // Writes to img3.transformation
            #ifdef USE_COMMAND_LINE_ARGS
                                        , g_src, cfg
            #endif
                                );
