...
cd ..
mv "./files_$(hostname)_imuAndTemperatureOnly_$missionName.tar.gz"  "./files_$(hostname)_videosTrimmedOnly_$missionName.tar.gz" Data/
cd Data
git add -A
git commit -m "$missionName data added"
git push
