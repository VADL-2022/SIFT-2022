# https://github.com/NixOS/nixpkgs/blob/nixos-21.11/pkgs/development/python-modules/matplotlib/default.nix#L84
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs =
    [ cycler python-dateutil numpy pyparsing tornado freetype qhull
      kiwisolver certifi libpng mock pytz (callPackage ./pillow.nix {}) #pillow
    ]
