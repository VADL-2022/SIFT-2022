# https://github.com/NixOS/nixpkgs/blob/nixos-21.11/pkgs/development/python-modules/scikit-image/default.nix#L99
...
in buildPythonPackage rec {
  ...
  propagatedBuildInputs = [
    # cloudpickle
    # dask
    (callPackage ./imageio.nix {}) #imageio
    (callPackage ./matplotlib.nix {Cocoa=Cocoa;}) #matplotlib
    networkx
    numpy
